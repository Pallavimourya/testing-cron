...
export async function GET(req: Request) {
  try {
    console.log("🔄 Test cron job trigger started at", ISTTime.getCurrentISTString())
    ...
    console.log(`✅ Test cron job completed: ${successCount} successful, ${failureCount} failed`)
    ...
    return NextResponse.json({ error: error.message || "Test cron job failed" }, { status: 500 })
  }
}
