      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
        <div className="space-y-6">
          <div className="animate-pulse">
            <div className="h-8 bg-gray-200 rounded w-full sm:w-1/4 mb-2"></div>
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
      <div className="space-y-6 lg:space-y-8">
        <div className="flex flex-col space-y-4 lg:flex-row lg:items-center lg:justify-between lg:space-y-0">
          <div className="space-y-2">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-gray-600">
              Welcome back! Here&apos;s what&apos;s happening with LinkZup.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 lg:gap-6">
          ...
          <Card className="bg-gradient-to-br from-emerald-50 to-emerald-100 border-emerald-200 hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              ...
              <p className={`text-xs mt-1 ${getGrowthColor(stats?.subscriptionGrowth || 0)}`}>
                {getGrowthIcon(stats?.subscriptionGrowth || 0)}
                {Math.abs(stats?.subscriptionGrowth || 0)}% from last month
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-orange-50 to-orange-100 border-orange-200 hover:shadow-lg transition-shadow sm:col-span-2 xl:col-span-1">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <CardContent>
              ...
              <p className={`text-xs mt-1 ${getGrowthColor(stats?.contentGrowth || 0)}`}>
                {getGrowthIcon(stats?.contentGrowth || 0)}
                {Math.abs(stats?.contentGrowth || 0)}% from last month
              </p>
            </CardContent>
          </Card>
        </div>
          ...
          <Card className="xl:col-span-2 border-0 shadow-lg">
            ...
            <CardContent>
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="text-center">
                  <div className="text-xl lg:text-2xl font-bold text-purple-600">{stats?.paymentSuccessRate || 0}%</div>
                  <div className="text-xs lg:text-sm text-gray-600">Success Rate</div>
                </div>
                <div className="text-center">
                  <div className="text-xl lg:text-2xl font-bold text-orange-600">{stats?.totalPayments || 0}</div>
                ...
                {stats.planRevenue.map((plan, index) => (
                  <div key={index} className="bg-gray-50 p-4 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      <div className="font-medium text-gray-900 text-sm lg:text-base truncate">{plan.planName}</div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardContent className="space-y-4">
              <Button
                className="w-full justify-start bg-blue-50 text-blue-700 border border-blue-200 hover:bg-blue-100 h-auto p-4"
                variant="outline"
              ...
              <Button
                className="w-full justify-start bg-emerald-50 text-emerald-700 border border-emerald-200 hover:bg-emerald-100 h-auto p-4"
                variant="outline"
              ...
              <Button
                className="w-full justify-start bg-purple-50 text-purple-700 border border-purple-200 hover:bg-purple-100 h-auto p-4"
                variant="outline"
